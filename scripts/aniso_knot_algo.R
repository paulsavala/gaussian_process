...
epa.df.sample.idx = sample(1:nrow(epa.df), 100)
epa.df = epa.df[epa.df.sample.idx, ]
...
# Data
data.knots = prepare_data(epa.df, M=5, num_knots=15, plot=T, df.sample=data.knots.spatial.df)
